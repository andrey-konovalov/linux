...
{
	/*
	 * The below #defines are guessed based on __video_try_fmt() code.
	 * TODO: implement video_enum_framesizes() properly - according to the
	 * camss manual.
	 */
#define CAMSS_FRAME_MIN_WIDTH	1
#define CAMSS_FRAME_MAX_WIDTH	8191
#define CAMSS_FRAME_MIN_HEIGHT	1
#define CAMSS_FRAME_MAX_HEIGHT	4096	/* if (video->line_based) == TRUE */
	...
	fsize->stepwise.max_height = CAMSS_FRAME_MAX_HEIGHT;
